...
//#region node_modules/.nitro/vite/services/ssr/assets/router-JuzUHYSB.js
...
var TooltipContent = import_react.forwardRef(({ className, sideOffset = 6, ...props }, ref) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Portal, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Content2, {
	ref,
	sideOffset,
	className: cn("z-50 overflow-hidden rounded-md bg-foreground px-2.5 py-1.5 text-xs text-background shadow-md", className),
	...props
}) }));
...
var styles_default = "/assets/styles-Dy3tOYcI.css";
var APP_NAME = "Polaris";
var Route$1 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "Polaris — терминал сигналов по стратегии «Северный тренд»: скан Binance, конфлюэнция, Telegram."
			},
			{
				name: "theme-color",
				content: "#0c0d0b"
...
var $$splitComponentImporter = () => import("./routes-C5VJa1KK.mjs");

...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-BP138qv4.mjs");
...
var manifest = {
	"421e7b1582aa53688f450302b94e0609a3fe6e5e6a476930b0b423cf678d1837": {
		functionName: "testTelegram_createServerFn_handler",
		importer: () => import("./market-hrmfi7kO.mjs")
	},
	"7eb6ce59a3f215bb493f51743fb4b4d3726409ea95238822b6d955407855d8ac": {
		functionName: "sendTelegram_createServerFn_handler",
		importer: () => import("./market-hrmfi7kO.mjs")
	},
	"b699399d0210bd6dd5631e3fde29c7caa322e4ac4428c66f2512b9e307a45bd4": {
		functionName: "getPairDetail_createServerFn_handler",
		importer: () => import("./market-hrmfi7kO.mjs")
	},
	"ffb8c9c8fecbe45ced597f5e61c17d0e9bc19b8b24a2959273f75e96b53b9205": {
		functionName: "scanMarket_createServerFn_handler",
		importer: () => import("./market-hrmfi7kO.mjs")
	}
};
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-JuzUHYSB.mjs").then((n) => n.t),
